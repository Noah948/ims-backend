## Main
2. in job - email should be unique, we can create a metadata file that will have all emails for easy lookup in entire DB
...
## Supabase
* advisors > performance advisor > info > uderstand and improve
* observabiity > query performance > advisor
* see auth and mail service
* understand features of database, edge functions, 
* integrations > cron